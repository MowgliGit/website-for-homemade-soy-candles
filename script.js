...
document.querySelector('.main-nav-list').addEventListener
('click', function(e){
  e.preventDefault();
  if(e.target.classList.contains('main-nav-link')){
...
document.querySelector('.quick-links').addEventListener
('click', function(e){
  e.preventDefault();
...
btnContainer.addEventListener('click', function(e){
  ...
  document.querySelector(`.testimonial-container--${clicked.dataset.tab}`).classList.add('testimonial-container--active');
